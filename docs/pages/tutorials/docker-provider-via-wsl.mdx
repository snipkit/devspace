...
The purpose of this quickstart is to provide a Docker environment via WSL, and a guide on how to integrate DevSpace to Docker running in WSL.
...
3. Step 8 relates to Integrating DevSpace with Docker in WSL
...
## Integrate DevSpace with Docker in WSL

### 8. Setup DevSpace Docker provider to use Docker installed in WSL
...
Following this tutorial, you should be able to use DevSpace with a Docker provider running in WSL. 
