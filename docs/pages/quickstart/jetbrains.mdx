...
<figure>
  <img src="/docs/media/create-workspace-jetbrains.png" alt="DevSpace Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-final-jetbrains.png" alt="DevSpace Flow" />
  <figcaption>Create Workspace</figcaption>
</figure>

A new window appears showing DevSpace starting the workspace. After the workspace was created, JetBrains Gateway should automatically open with a prefilled form for the workspace.

<figure>
  <img src="/docs/media/create-workspace-jetbrains-2.png" alt="DevSpace Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-jetbrains-3.png" alt="DevSpace Flow" />
