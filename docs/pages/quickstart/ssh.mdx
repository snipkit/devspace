...
<figure>
  <img src="/docs/media/create-workspace-ssh.png" alt="DevSpace Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-final-ssh.png" alt="DevSpace Flow" />
  <figcaption>Create Workspace</figcaption>
</figure>

A new window appears showing DevSpace starting the workspace. After the workspace was created, you can connect to the workspace via ssh:
