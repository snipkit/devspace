...
For cloud providers, these machines are typically virtual machines (VMs). DevSpace manages the lifecycle of these machines, including creation and deletion of a workspace.
