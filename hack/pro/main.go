...
var checksumMap = map[string]string{
	"./release/devspace-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devspace-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devspace-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devspace-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devspace-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
