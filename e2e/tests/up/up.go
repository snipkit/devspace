...
var _ = DevSpaceDescribe("devspace up test suite", func() {
	ginkgo.Context("testing up command", ginkgo.Label("up"), ginkgo.Ordered, func() {
		...
		ginkgo.It("create workspace in a subpath", func() {
			...
			err = f.DevSpaceUp(ctx, "https://github.com/khulnasoft-lab/examples@subpath:/devspace/jupyter-notebook-hello-world")
			framework.ExpectNoError(err)
		...
		ginkgo.It("recreate a remote workspace", func() {
			...
			// recreate
			err = f.DevSpaceUpRecreate(ctx, "https://github.com/khulnasoft-lab/examples@subpath:/devspace/jupyter-notebook-hello-world")
			framework.ExpectNoError(err)
		...
		ginkgo.It("reset a remote workspace", func() {
			...
			// reset
			err = f.DevSpaceUpReset(ctx, "https://github.com/khulnasoft-lab/examples/@subpath:/devspace/jupyter-notebook-hello-world")
			framework.ExpectNoError(err)
