...
const (
	SleepModeForceAnnotation          = "sleepmode.khulnasoft.com/force"
	SleepModeForceDurationAnnotation  = "sleepmode.khulnasoft.com/force-duration"
	SleepModeSleepAfterAnnotation     = "sleepmode.khulnasoft.com/sleep-after"
	SleepModeDeleteAfterAnnotation    = "sleepmode.khulnasoft.com/delete-after"
	SleepModeSleepScheduleAnnotation  = "sleepmode.khulnasoft.com/sleep-schedule"
	SleepModeWakeupScheduleAnnotation = "sleepmode.khulnasoft.com/wakeup-schedule"
	SleepModeTimezoneAnnotation       = "sleepmode.khulnasoft.com/timezone"

	SleepModeLastActivityAnnotation      = "sleepmode.khulnasoft.com/last-activity"
	SleepModeLastActivityAnnotationInfo  = "sleepmode.khulnasoft.com/last-activity-info"
	SleepModeSleepingSinceAnnotation     = "sleepmode.khulnasoft.com/sleeping-since"
	SleepModeCurrentEpochStartAnnotation = "sleepmode.khulnasoft.com/current-epoch-start"
	SleepModeCurrentEpochSleptAnnotation = "sleepmode.khulnasoft.com/current-epoch-slept"
	SleepModeLastEpochStartAnnotation    = "sleepmode.khulnasoft.com/last-epoch-start"
	SleepModeLastEpochSleptAnnotation    = "sleepmode.khulnasoft.com/last-epoch-slept"
	SleepModeScheduledSleepAnnotation    = "sleepmode.khulnasoft.com/scheduled-sleep"
	SleepModeScheduledWakeupAnnotation   = "sleepmode.khulnasoft.com/scheduled-wakeup"
	SleepModeSleepTypeAnnotation         = "sleepmode.khulnasoft.com/sleep-type"
	SleepModeDisableIngressWakeup        = "sleepmode.khulnasoft.com/disable-ingress-wakeup"
	SleepModeDisableMetricsTracking      = "sleepmode.khulnasoft.com/disable-metrics-tracking"

	// Not yet in spec annotations
	SleepModeIgnoreAll                     = "sleepmode.khulnasoft.com/ignore-all"
	SleepModeIgnoreIngresses               = "sleepmode.khulnasoft.com/ignore-ingresses"
	SleepModeIgnoreGroupsAnnotation        = "sleepmode.khulnasoft.com/ignore-groups"
	SleepModeIgnoreVClustersAnnotation     = "sleepmode.khulnasoft.com/ignore-vclusters"
	SleepModeIgnoreResourcesAnnotation     = "sleepmode.khulnasoft.com/ignore-resources"
	SleepModeIgnoreVerbsAnnotation         = "sleepmode.khulnasoft.com/ignore-verbs"
	SleepModeIgnoreResourceVerbsAnnotation = "sleepmode.khulnasoft.com/ignore-resource-verbs" // format: myresource.mygroup=create update delete, myresource2.mygroup=create update
	SleepModeIgnoreResourceNamesAnnotation = "sleepmode.khulnasoft.com/ignore-resource-names" // format: myresource.mygroup=name1 name2
	SleepModeIgnoreActiveConnections       = "sleepmode.khulnasoft.com/ignore-active-connections"
	SleepModeIgnoreUserAgents              = "sleepmode.khulnasoft.com/ignore-user-agents" // format: useragent1,useragentprefix/*,*
...
type SleepModeConfigSpec struct {
	...
	// During this period khulnasoft will also block certain requests to that space.
...
type SleepModeConfigStatus struct {
	...
	// SleepingSince specifies since when the space is sleeping (if this is not specified, khulnasoft assumes the space is not sleeping)
	// +optional
