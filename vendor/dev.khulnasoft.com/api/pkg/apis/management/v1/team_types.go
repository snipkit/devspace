...
// +genclient:method=ListClusters,verb=get,subresource=clusters,result=dev.khulnasoft.com/api/pkg/apis/management/v1.TeamClusters
// +genclient:method=ListAccessKeys,verb=get,subresource=accesskeys,result=dev.khulnasoft.com/api/pkg/apis/management/v1.TeamAccessKeys
