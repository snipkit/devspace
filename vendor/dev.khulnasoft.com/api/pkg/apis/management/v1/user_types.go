...
// +genclient:method=GetProfile,verb=get,subresource=profile,result=dev.khulnasoft.com/api/pkg/apis/management/v1.UserProfile
// +genclient:method=ListClusters,verb=get,subresource=clusters,result=dev.khulnasoft.com/api/pkg/apis/management/v1.UserClusters
// +genclient:method=ListAccessKeys,verb=get,subresource=accesskeys,result=dev.khulnasoft.com/api/pkg/apis/management/v1.UserAccessKeys
