...
// +genclient:method=ListAccess,verb=get,subresource=memberaccess,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ClusterMemberAccess
// +genclient:method=ListMembers,verb=get,subresource=members,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ClusterMembers
// +genclient:method=ListVirtualClusterDefaults,verb=get,subresource=virtualclusterdefaults,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ClusterVirtualClusterDefaults
// +genclient:method=GetAgentConfig,verb=get,subresource=agentconfig,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ClusterAgentConfig
// +genclient:method=GetAccessKey,verb=get,subresource=accesskey,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ClusterAccessKey
