...
// +genclient:method=ListMembers,verb=get,subresource=members,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectMembers
// +genclient:method=ListTemplates,verb=get,subresource=templates,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectTemplates
// +genclient:method=ListRunners,verb=get,subresource=runners,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectRunners
// +genclient:method=ListClusters,verb=get,subresource=clusters,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectClusters
// +genclient:method=MigrateVirtualClusterInstance,verb=create,subresource=migratevirtualclusterinstance,input=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectMigrateVirtualClusterInstance,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectMigrateVirtualClusterInstance
// +genclient:method=ImportSpace,verb=create,subresource=importspace,input=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectImportSpace,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectImportSpace
// +genclient:method=MigrateSpaceInstance,verb=create,subresource=migratespaceinstance,input=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectMigrateSpaceInstance,result=dev.khulnasoft.com/api/pkg/apis/management/v1.ProjectMigrateSpaceInstance
