	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1().DevSpaceWorkspaceTemplates().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1().DevSpaceWorkspaceTemplates().Watch(context.TODO(), options)
			},
		},
		&storagev1.DevSpaceWorkspaceTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devSpaceWorkspaceTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1.DevSpaceWorkspaceTemplate{}, f.defaultInformer)
}
