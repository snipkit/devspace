...
// Button is an object that represents a button in the Khulnasoft UI that links to some external service
...
type Button struct {
	...
	// never be shown in the khulnasoft UI.
	// +optional
	DisplayText string `json:"displayText,omitempty"`
	// Direct indicates if the Khulnasoft front end should directly hit this endpoint. If false, it means
	// that the Khulnasoft front end will be hitting the license server first to generate a one time token
