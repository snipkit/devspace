...
import { Briefcase, CheckCircle, DevSpaceProBadge, ExclamationTriangle, Plus } from "@/icons"
...
export function Pro() {
  ...
  return experimental_devSpacePro ? (
    <>
                ...
                {proInstances === undefined || proInstances.length === 0 ? (
                  <VStack align="start" padding="2" spacing="0">
                    ...
                    <Text lineHeight={"1.2rem"} fontSize="sm" color="gray.500">
                      ...
                      <Link
                        color="primary.600"
                        onClick={() => client.open("https://dev.khulnasoft.com/pro")}>
                        Learn more
                      </Link>
                    </Text>
