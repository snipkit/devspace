...
import { ManagementV1Cluster } from "@khulnasoft-enterprise/client/gen/models/managementV1Cluster"
import { ManagementV1DevSpaceWorkspaceInstanceKubernetesStatus } from "@khulnasoft-enterprise/client/gen/models/managementV1DevSpaceWorkspaceInstanceKubernetesStatus"
import {
...
} from "@khulnasoft-enterprise/client/gen/models/managementV1DevSpaceWorkspaceInstancePersistentVolumeClaimStatus"
import {
    ManagementV1DevSpaceWorkspaceInstancePodStatus,
    ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum,
} from "@khulnasoft-enterprise/client/gen/models/managementV1DevSpaceWorkspaceInstancePodStatus"
import { ManagementV1DevSpaceWorkspaceTemplate } from "@khulnasoft-enterprise/client/gen/models/managementV1DevSpaceWorkspaceTemplate"
...
type TKubernetesDetailsProps = Readonly<{
    status: ManagementV1DevSpaceWorkspaceInstanceKubernetesStatus
}>
...
function PodStatus({ podStatus }: { podStatus: ManagementV1DevSpaceWorkspaceInstancePodStatus }) {
    const phase = podStatus.phase
    const phaseColor = {
        [ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum.Pending]: "yellow.500",
        [ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum.Running]: "",
        [ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum.Succeeded]: "red.400",
        [ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum.Failed]: "red.400",
        [ManagementV1DevSpaceWorkspaceInstancePodStatusPhaseEnum.Unknown]: "red.400",
    }
...
function PvcStatus({
    ...
    if (phase !== ManagementV1DevSpaceWorkspaceInstancePersistentVolumeClaimStatusPhaseEnum.Bound) {
