...
import { getProjectNamespace, NewResource, Resources } from "@khulnasoft-enterprise/client"
...
): Promise<Result<{ workspaceID: string; instance: ManagementV1DevSpaceWorkspaceInstance }>> {
    const instance = NewResource(Resources.ManagementV1DevSpaceWorkspaceInstance)
