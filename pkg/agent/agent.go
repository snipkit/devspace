...
func DefaultAgentDownloadURL() string {
	...
	if version.GetVersion() == version.DevVersion {
		return "https://dev.khulnasoft.com/releases/latest/download/"
	}
...
func decodeWorkspaceInfoAndWrite(
	...
	// We only have write access to /var/lib/khulnasoft/* by default causing nearly all local folders to run into permissions issues
