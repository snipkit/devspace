...
func TestNormalizeRepository(t *testing.T) {
	testCases := []testCaseNormalizeRepository{
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace-without-branch.git",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace-without-branch.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace-with-branch.git@test-branch",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace-with-branch.git",
			expectedPRReference: "",
			expectedBranch:      "test-branch",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace-with-branch.git@test_branch",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace-with-branch.git",
			expectedPRReference: "",
		...
		{
			in:                  "ssh://git@github.com:khulnasoft-sh/devspace.git@test_branch",
			expectedRepo:        "ssh://git@github.com:khulnasoft-sh/devspace.git",
			expectedPRReference: "",
			expectedBranch:      "test_branch",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace-with-slash.git@user/branch",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace-with-slash.git",
			expectedPRReference: "",
			expectedBranch:      "user/branch",
			expectedCommit:      "",
			expectedSubpath:     "",
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace.git@sha256:905ffb0",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace.git",
			expectedPRReference: "",
			expectedBranch:      "",
			expectedCommit:      "905ffb0",
			expectedSubpath:     "",
		...
		{
			in:                  "git@github.com:khulnasoft-sh/devspace.git@pull/996/head",
			expectedRepo:        "git@github.com:khulnasoft-sh/devspace.git",
			expectedPRReference: "pull/996/head",
			expectedBranch:      "",
			expectedCommit:      "",
