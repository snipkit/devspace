...
// primary endpoint that Khulnasoft instances will hit to register to the license server as well as get
// information about the instance's current license.
// +k8s:deepcopy-gen=true
type InstanceCreateInput struct {
	*InstanceTokenAuth `hash:"-"`

	// Product is the product that is being used. Can be empty, khulnasoft, devspace-pro or vcluster-pro.
	...
	KhulnasoftVersion string `json:"version"     form:"version"     validate:"required"`
...
type InstanceCreateOutput struct {
	// License is the license data for the requested Khulnasoft instance.
