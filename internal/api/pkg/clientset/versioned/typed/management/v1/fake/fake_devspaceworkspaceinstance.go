...
// GetState takes name of the devSpaceWorkspaceInstance, and returns the corresponding devSpaceWorkspaceInstanceState object, and an error if there is any.
func (c *FakeDevSpaceWorkspaceInstances) GetState(ctx context.Context, devSpaceWorkspaceInstanceName string, options metav1.GetOptions) (result *v1.DevSpaceWorkspaceInstanceState, err error) {
	emptyResult := &v1.DevSpaceWorkspaceInstanceState{}
	obj, err := c.Fake.
		Invokes(testing.NewGetSubresourceActionWithOptions(devspaceworkspaceinstancesResource, c.ns, "state", devSpaceWorkspaceInstanceName, options), emptyResult)

	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.DevSpaceWorkspaceInstanceState), err
}
...
func (c *FakeDevSpaceWorkspaceInstances) SetState(ctx context.Context, devSpaceWorkspaceInstanceName string, devSpaceWorkspaceInstanceState *v1.DevSpaceWorkspaceInstanceState, opts metav1.CreateOptions) (result *v1.DevSpaceWorkspaceInstanceState, err error) {
	emptyResult := &v1.DevSpaceWorkspaceInstanceState{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateSubresourceActionWithOptions(devspaceworkspaceinstancesResource, devSpaceWorkspaceInstanceName, "state", c.ns, devSpaceWorkspaceInstanceState, opts), emptyResult)
...
// Troubleshoot takes name of the devSpaceWorkspaceInstance, and returns the corresponding devSpaceWorkspaceInstanceTroubleshoot object, and an error if there is any.
func (c *FakeDevSpaceWorkspaceInstances) Troubleshoot(ctx context.Context, devSpaceWorkspaceInstanceName string, options metav1.GetOptions) (result *v1.DevSpaceWorkspaceInstanceTroubleshoot, err error) {
	emptyResult := &v1.DevSpaceWorkspaceInstanceTroubleshoot{}
	obj, err := c.Fake.
		Invokes(testing.NewGetSubresourceActionWithOptions(devspaceworkspaceinstancesResource, c.ns, "troubleshoot", devSpaceWorkspaceInstanceName, options), emptyResult)

	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.DevSpaceWorkspaceInstanceTroubleshoot), err
}
