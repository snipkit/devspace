...
var file_runner_proto_goTypes = []interface{}{
	(*CloneRequest)(nil),  // 0: devspace.CloneRequest
	(*CloneResponse)(nil), // 1: devspace.CloneResponse
}
var file_runner_proto_depIdxs = []int32{
	0, // 0: devspace.Runner.Clone:input_type -> devspace.CloneRequest
	1, // 1: devspace.Runner.Clone:output_type -> devspace.CloneResponse
