...
// +genclient:method=GetConfig,verb=get,subresource=config,result=dev.khulnasoft.com/api/pkg/apis/management/v1.RunnerConfig
// +genclient:method=GetAccessKey,verb=get,subresource=accesskey,result=dev.khulnasoft.com/api/pkg/apis/management/v1.RunnerAccessKey
