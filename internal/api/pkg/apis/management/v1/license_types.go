...
// +genclient:method=LicenseRequest,verb=create,subresource=request,input=dev.khulnasoft.com/api/pkg/apis/management/v1.LicenseRequest,result=dev.khulnasoft.com/api/pkg/apis/management/v1.LicenseRequest
