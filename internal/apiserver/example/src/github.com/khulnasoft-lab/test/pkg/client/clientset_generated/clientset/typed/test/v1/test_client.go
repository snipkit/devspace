...
import (
	...
	v1 "github.com/khulnasoft-lab/test/apis/test/v1"
	"github.com/khulnasoft-lab/test/pkg/client/clientset_generated/clientset/scheme"
...
// NewForConfigAndClient creates a new TestV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TestV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
