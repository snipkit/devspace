...
func (c *FakeClusterRoles) UpdateStatus(ctx context.Context, clusterRole *v1.ClusterRole, opts metav1.UpdateOptions) (*v1.ClusterRole, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clusterrolesResource, "status", clusterRole), &v1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterRole), err
