...
import (
	...
	helperssh "dev.khulnasoft.com/pkg/ssh/server"
	"dev.khulnasoft.com/pkg/ssh/server/port"
	"dev.khulnasoft.com/log"
	"github.com/sirupsen/logrus"
	"github.com/spf13/cobra"
)

const BaseLogDir = "/var/devspace"
...
func getFileLogger(remoteUser string, debug bool) log.Logger {
	...
	targetFolder := filepath.Join(os.TempDir(), ".devspace")
	if remoteUser != "" {
